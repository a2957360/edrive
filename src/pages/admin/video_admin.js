...
import { getVideo, addVideo} from '../../actions/video';
...
function Dashboard() {
    ...
    let [editdate, setEditdate] = React.useReducer(
        ...
        { videoId: "", videoTitle: "", videoContent: "", videotype:""  }
    );
    ...
    const message = useSelector(state => state.videoData.message);
    ...
    const headCells = [
        { id: 'videoTitle', numeric: false, disablePadding: false, label: '视频标题' },
        { id: 'videoContent', numeric: false, disablePadding: false, label: '视频链接' },
        // { id: 'videotype', numeric: false, disablePadding: false, label: '常见问题分类' }
    ];
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12}>
                            ...
                            <Paper className={classes.paper}>
                                <DisplayTable rows={videoList} headCells={headCells} deleteFunction={deleteFunction} editFunction={editFunction} />
                            </Paper>
                        </Grid>
                    </Grid>
                    <Box pt={4}>
                            ...
                            <form noValidate autoComplete="off" onChange={handleOnChange} onSubmit={handleOnSubmit}>
                                <div class="col-md-12 padding-left-25">
                                    <div className="margin-top-10">
                                        <input type="hidden" name="videoId" value={editdate.videoId} />
                                        <TextField name="videoTitle" label="视频标题" fullWidth value={editdate.videoTitle}
                                            InputLabelProps={{
                                                shrink: true,
                                            }} />
                                    </div>
                                    <div class="margin-top-10">
                                        <TextField multiline rows={20} id="outlined-basic" name="videoContent" fullWidth label="链接" variant="outlined" value={editdate.videoContent} />
                                    </div>
                                    {/* <div class="margin-top-10">
