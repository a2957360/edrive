...
function Dashboard() {
    ...
    const headCells = [
        ...
        { id: 'haveCoach', numeric: false, disablePadding: false, label: '是否有教练' },
        { id: 'coachName', numeric: false, disablePadding: false, label: '教练名字' },
    ];
                                                            ...
                                                            <li>
                                                                <a onClick={() => selectCoach(course)} class="stu-cell">
                                                                    ...
                                                                    <div class="col">
                                                                        ...
                                                                        <div class="stu-ads">区域：{course.serverLocation} 备选：{course.backupServerLocation}</div>
                                                                    </div>
                                                                </a>
                                                            </li>)
                                                    }
                                    ...
                                    <div class="col-md-8">
                                        <div class="jd-cells">
                                            ...
                                            <div class="row jd-row">
                                                <div class="col-xs-12">
                                                    <div class="jd-account">
                                                        教练编号(COACH NO.): <span class="id">{coachdate.userNumber}</span>
                                                    </div>
                                                </div>
                                                <div class="col-xs-6 col-md-3">
                                                    <div class="form-row">
