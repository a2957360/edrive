...
function Dashboard() {
    ...
    const headCells = [
        ...
        { id: 'finishedCourseTime', numeric: false, disablePadding: false, label: '完成理论时间' },
                        ...
                        <div className="row">
                            <div class="col-md-12 padding-left-25 jd-cells">
                                <div className="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="row jd-row">
                                            <div class="jd-heading">{editdate.reservationArea}理论课程时间</div>
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-row">
                                                    <div class="form-label">理论课时间</div>
                                                    <div class="form-val">{editdate.courseTime}Hr</div>
                                                </div>
                                            </div>
                                            <form class="col-xs-12 col-md-6" onChange={handleOnChange}>
                                                <div class="form-row">
                                                    <div class="form-label">理论课完成时间</div>
                                                    <div class="form-val">
