...
import StudentInfo from './student_form';
...
function Dashboard() {
    ...
    const handleClick = (event) => {
        ...
        let data = {isSignupCoach:1,userName:"新学员",userRole:"0"};
    ...
    const headCells = [
        ...
        { id: 'licenseName', numeric: false, disablePadding: false, label: '学员名字' },
    ...
    return (
        <div className={classes.root}>
            ...
            <main className={classes.content}>
                ...
                >
                    <StudentInfo userId={editdate.userId}/>
                </Popover>
            </main>
        </div>
    );
