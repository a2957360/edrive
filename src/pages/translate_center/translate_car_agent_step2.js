...
function QuestionResult() {
    ...
    const handleOnSubmit = React.useCallback(event => {
        ...
        fileData.append("translateName", "车管所翻译");
        fileData.append("translatePrice", translatePrice);
        translateSectionList["translateName"]="车管所翻译";
    ...
    useEffect(() => {
        if(priceinfo == null){
            ...
            settranslatePrice(parseFloat(priceinfo[translateArray['carAgent']]['priceAmount']));
        }
    }, [dispatch,priceinfo])
    return (
        <div>
                            ...
                            <ul class="row upload-rows" id="warp">
                                <li class="col-sm-6">
                                    <div class="atio-upload">
                                        ...
                                        <div class="txt">车管所证明第一页{errors.frontImage1 && <p className="input_error">必填</p>}</div>
                                        <div class="uplad-box">
